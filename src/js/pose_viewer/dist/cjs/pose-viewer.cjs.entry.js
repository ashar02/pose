...
class SVGPoseRenderer extends PoseRenderer {
  renderJoint(i, joint, color) {
    const { R, G, B } = color;
    return (index.h("circle", { cx: joint.X, cy: joint.Y, r: 4, class: "joint draggable", style: ({
        fill: `rgb(${R}, ${G}, ${B})`,
  ...
  renderLimb(from, to, color) {
    const { R, G, B } = color;
    return (index.h("line", { x1: from.X, y1: from.Y, x2: to.X, y2: to.Y, style: {
        stroke: `rgb(${R}, ${G}, ${B})`,
  ...
  render(frame) {
    ...
    return (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: viewBox, width: this.viewer.elWidth, height: this.viewer.elHeight },
      index.h("g", null, this.renderFrame(frame))));
  }
}
...
class CanvasPoseRenderer extends PoseRenderer {
  ...
  render(frame) {
    ...
    return (index.h("canvas", { width: this.viewer.elWidth, height: this.viewer.elHeight }));
  }
}
...
const PoseViewer = class {
  constructor(hostRef) {
    ...
    this.canplaythrough$ = index.createEvent(this, "canplaythrough$", 7);
    this.ended$ = index.createEvent(this, "ended$", 7);
    this.loadeddata$ = index.createEvent(this, "loadeddata$", 7);
    this.loadedmetadata$ = index.createEvent(this, "loadedmetadata$", 7);
    this.loadstart$ = index.createEvent(this, "loadstart$", 7);
    this.pause$ = index.createEvent(this, "pause$", 7);
    this.play$ = index.createEvent(this, "play$", 7);
    this.firstRender$ = index.createEvent(this, "firstRender$", 7);
    this.render$ = index.createEvent(this, "render$", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, null, render));
  }
...
exports.pose_viewer = PoseViewer;

//# sourceMappingURL=pose-viewer.cjs.entry.js.map